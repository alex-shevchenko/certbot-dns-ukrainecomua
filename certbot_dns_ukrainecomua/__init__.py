"""
The `~certbot_dns_ukrainecomua.dns_ukrainecomua` plugin automates the process of
completing a ``dns-01`` challenge (`~acme.challenges.DNS01`) by creating, and
subsequently removing, TXT records using the Ukraine.com.ua API.

Named Arguments
---------------

========================================  =====================================
``--dns-ukrainecomua-credentials``            Ukraine.com.ua credentials_ INI file.
                                          (Required)
``--dns-ukrainecomua-propagation-seconds``    The number of seconds to wait for DNS
